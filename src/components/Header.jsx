        ...
        <div className="container">
          ...
          <nav className="nav-menu">
            <ul>
              ...
              <li><a href="#">MEDIA & TECHNOLOGIE</a></li>
        ...
        <div className="container">
          <div className="hero-content">
            <h2 className="hero-title">
              <span className="dynamic-text">Demain</span>
              <span className="dynamic-text">Dès</span>
              <span className="dynamic-text">Maintenant.</span>
            </h2>
            <p className="hero-tagline">L'Accompagnateur des chefs d'entreprise</p>
          </div>
        </div>
      </div>
    </header>
